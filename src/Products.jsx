...
function Products() {
  ...
  return (
    <>
      ...
      >
        {selectedProduct && (
          <div className="bg-[#1d1d1d] text-white p-6 rounded-lg shadow-md text-center">
      ...
      <div className="p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {products.map(product => (
            <div
              key={product.id}
              className="bg-[#1d1d1d] p-4 rounded-lg text-center shadow-md hover:shadow-xl transition"
            >
              <img
                src={product.image}
                alt={product.title}
              ...
              <button
                className="border-2 border-blue-500 text-blue-500 mt-2 px-4 py-2 rounded hover:bg-blue-500 hover:text-white transition"
                onClick={() => {
